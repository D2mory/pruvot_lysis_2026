function x = model_WEI_eqs(p)
% function x = model_WEI_eqs(p)
%
% Evaluates the equilibrium state of the marine microbial ecosystem
% described in Weitz et al. (2015)
%
% Inputs:
% . p : parameters (structure with 37 fields)
%
% Outputs:
% . x : equilibrium state
%
